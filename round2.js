...
recognition.onresult = function(event) {
    ...
    if(content == originaltext) {       
        document.getElementById("result").innerHTML = "Congrats! You matched the sentence correctly and passed round 2. Let's move on to round 3."
        setTimeout(function(){
            window.location = "round3.html";
        }, 3000);
